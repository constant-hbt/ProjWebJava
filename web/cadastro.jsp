...
<body>
    <div class="row">
        ...
        <div class="col-md-6" id="cadastro">
            ...
            <form action="" method="post" name="frmCadastro" class="formCadastro" onsubmit="return validaSubmit()">
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <input type="submit" value="Cadastrar" class="btn btn-danger btn-submit text-white">
                        </div>
                    </div>
                </div>
            </form>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div id="modal_titulo_div">
                        <h5 class="modal-title" id="modal_titulo">Registro inserido com sucesso</h5>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="" id="modal_btn" data-dismiss="modal">Voltar</button>
                    </div>
                </div>
            </div>
        </div>
